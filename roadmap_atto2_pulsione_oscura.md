...
- [⭐ LA CATENA DECISIVA: Isobel, poi il compagno più caro](#-la-catena-decisiva-isobel-poi-il-compagno-più-caro)
  ...
  - [Passo 2 — La notte del compagno più caro](#passo-2--la-notte-del-compagno-più-caro)
  - [🎲 Come si passa il TS su Saggezza CD 14 — la lista completa](#-come-si-passa-il-ts-su-saggezza-cd-14--la-lista-completa)
  - [🚪 La via d'uscita: non riposare](#-la-via-duscita-non-riposare)
- [🩸 Il Carnefice (*Slayer*): cosa ti dà davvero](#-il-carnefice-slayer-cosa-ti-dà-davvero)
- [🩸 Tutte le altre pulsioni dell'Atto 2](#-tutte-le-altre-pulsioni-dellatto-2)
- [📋 Tutte le missioni dell'Atto 2](#-tutte-le-missioni-dellatto-2)
- [🗺️ Luoghi e PNG d'interesse](#️-luoghi-e-png-dinteresse)
- [🎁 Tutti i bonus permanenti dell'Atto 2](#-tutti-i-bonus-permanenti-dellatto-2)
- [⚔️ Gli oggetti forti dell'Atto 2](#️-gli-oggetti-forti-dellatto-2)
- [✅ Lista di controllo prima di lasciare l'Atto 2](#-lista-di-controllo-prima-di-lasciare-latto-2)
- [📚 Fonti](#-fonti)

> **Simboli:** 🩸 = evento della Pulsione · ⚠️ = missabile · ⛔ = chiude contenuti · 🎲 = tiro di dado · ⭐ = da non sbagliare.
...
## ⭐ LA CATENA DECISIVA: ISOBEL, POI IL COMPAGNO PIÙ CARO
...
### Passo 1 — Sceleritas chiede la testa di Isobel

Compare a un riposo lungo e ti ordina di uccidere **Isobel** alla **Locanda dell'Ultima Luce** — e con lei, di fatto, tutti quelli che stanno dentro.
...
### Passo 2 — La notte del compagno più caro

A un riposo lungo successivo (di norma dopo aver risolto la Coltre Oscura), Sceleritas ti avvisa: **stanotte ucciderai qualcuno che ti sta a cuore**.

**Chi è il bersaglio:**
- il tuo **partner** se hai una romance attiva;
- altrimenti il compagno con l'**approvazione più alta**;
- ⛔ **esclusi**: i compagni reclutati nell'Atto 2 (Halsin, Jaheira, Minthara) e **Gale se il suo globo non è ancora stabilizzato**.

La scena parte da sola: ti alzi e ti avvicini alla vittima. Le opzioni sono tre — **provare a svegliarla e salvarla**, **ucciderla deliberatamente**, oppure **tornare a dormire** (che equivale a ucciderla).

### 🎲 Come si passa il TS su Saggezza CD 14 — la lista completa

⚠️ **Regola che rovina le partite:** su questo tiro contano **solo** l'equipaggiamento indossato, i buff già attivi prima di addormentarti, e i consumabili usati **dall'inventario durante il dialogo**. Non puoi lanciarti un incantesimo nel mezzo della scena. *(Curiosamente, un'Opposizione/`Resistenza` lanciata prima di riposare **non** viene applicata: è così e basta.)*

**Oggetti che aumentano il tiro**
...
Il compagno si sveglia, **ti lega le mani dietro la schiena** e passa la notte a vegliarti mentre la Pulsione si dimena dentro di te. Ci sono due tiri extra, entrambi **TS su Saggezza CD 18**:

1. il primo per **restare lucido** e capire quello che il compagno ti sta dicendo;
2. il secondo — **con svantaggio** — per riuscire a **ringraziarlo**.

Fallirli non ha conseguenze meccaniche: cambia solo (in meglio) la scena. Le reazioni sono diverse per ogni compagno e cambiano anche in base al fatto che nell'Atto 1 tu abbia ammesso o no l'omicidio di Alfira. **È una delle scene migliori del gioco: vale il lavoro di preparazione.**
...
### 🚪 La via d'uscita: non riposare

Esiste un modo pulito per **non affrontare mai** questa scena: **non fare riposi lunghi dentro le Terre Maledette dall'Ombra**. A differenza di quasi tutti gli eventi obbligatori al campo, questo **non viene messo in coda**: quando lasci l'Atto 2, il gioco prosegue come se avessi risparmiato **sia Isobel sia il tuo compagno**.

- ✅ **Pro:** zero rischio di dado, zero possibilità di perdere un compagno.
...
## 🩸 IL CARNEFICE (*SLAYER*): COSA TI DÀ DAVVERO

La ricompensa che Bhaal concede ai suoi figli prediletti: ti trasformi in un mostro **Grande** a quattro braccia. È la stessa forma che prende **Orin** nel suo scontro.

**Come si ottiene:** in **Atto 2** uccidendo **Isobel** *oppure* il **compagno più caro**. In alternativa in **Atto 3**, accettando di tornare Prescelto di Bhaal dopo aver sconfitto Orin.

| | Livello 1-9 | Livello 10+ |
|---|---|---|
| **Classe Armatura** | 16 | 16 |
| **Punti Ferita** | 98 | **153** |
| **Forza** | 20 | **25** |
| **Movimento** | 10,5 m | 10,5 m |

**Azioni:** *Multiattacco*, *Colpo Letale* (**Slay**), *Balzo Implacabile* (chiude la distanza), *Sontuoso Bagno di Sangue* (sanguinamento), *Che il Massacro Abbia Inizio*, *Congeda: Carnefice*. Con il libro di Volo dell'Atto 3 si aggiunge **Ringhio Perforante**.

### ⚠️ I limiti (leggili prima di contare sul Carnefice)

- **Non puoi parlare.** Niente dialoghi, niente attivazione di oggetti che richiedono la parola (es. la Campanella Filigranata), e alcune **scene si rompono**: la più famosa è la cinematica dell'esercito sulla strada per Baldur's Gate, che viene saltata — risultato: **tutto il gruppo finisce in prigione** senza l'opzione di ritirarsi.
- **L'equipaggiamento smette di funzionare** (come la Forma Selvatica del druido): niente Mantello del Cacciatore di Morte, niente anelli, niente armi.
- **Le caratteristiche mentali diventano 10 / 10 / 8**: gli incantesimi e le CD della tua classe spariscono.
- **I suoi attacchi non contano come magici**: contro le **ombre** (cioè metà dei nemici dell'Atto 2) fai **metà danno**.
...
## 🩸 TUTTE LE ALTRE PULSIONI DELL'ATTO 2
...
| **Colonia dei Divoratori di Menti** | Zevlor, Mizora, **Us** in gabbia, l'Interfaccia Mnemonica | **Evoca Us** e la **Barriera Mentale Githzerai** sono qui |
...
| **Sangue Instabile** (1ª metà) | Il tuo sangue diventa infiammabile | Fai prelevare il sangue da **Araj Oblodra** qui, poi cercala nell'Atto 3 | Si completa nell'Atto 3 |

---

## ⚔️ GLI OGGETTI FORTI DELL'ATTO 2

| Oggetto | Effetto | Dove | Per la Pulsione Oscura |
|---|---|---|---|
...
## ✅ LISTA DI CONTROLLO PRIMA DI LASCIARE L'ATTO 2

- [ ] ⭐ **Mantello di Protezione** comprato da Talli **appena arrivato** (poi può diventare irraggiungibile)
- [ ] ⭐ **Elmo dell'Autonomia** indossato prima del riposo critico (raccolto nell'Atto 1)
- [ ] ⭐ **Elisir di Eroismo in inventario** e **3+ Ispirazioni** in banca prima del riposo critico
- [ ] ⛔ **Anello Rischioso / Pietra di Risonanza tolti** prima di dormire
- [ ] 🩸 **Isobel risparmiata** · 🩸 **TS CD 14 superato** (o evento evitato consapevolmente)
- [ ] **Aylin risparmiata** (altrimenti Isobel muore e conta come tua)
- [ ] **Dolly Dolly Dolly liberata e NON schiacciata** → Benedizione della Pixie
- [ ] **Amore dell'Assassino** raccolto nel Guanto di Shar
- [ ] I **tre blocchi permanenti** della run buona rispettati (Halsin, Mizora/Wyll, Cuorescuro in squadra)
- [ ] **Jaheira reclutata** prima di scendere sotto le Torri (senza di lei niente Minsc nell'Atto 3)
- [ ] **Pozione di Vigore Perenne** decisa (sì/no) · **sangue dato ad Araj** se vuoi il *Sangue Instabile*
- [ ] Salvataggio manuale dedicato prima di partire per Baldur's Gate
