# Baldur's Gate 3 — Guide per una run "buona" (PS5, Patch 8)

Raccolta di guide personali per una partita **eroica/non malvagia** di Baldur's Gate 3 su PS5, costruite nel tempo con l'aiuto di Claude: roadmap tappa per tappa per i tre atti più una guida di build/equipaggiamento livello per livello per tutto il party.
...
- **Run "tutta buona"**: ai bivi morali (es. Boschetto di Smeraldo/Minthara, Cuorescuro, alleati da salvare) le guide indicano sempre la via eroica, segnalando comunque le conseguenze delle alternative.
- **Obiettivo doppio**: massimizzare sia i **trofei PSN** sia la **forza delle build**, senza compromessi tra i due.
...
- 🏆 trofeo · ⚠️ missabile (perso per sempre se saltato) · ⏱️ a tempo · 🚩 punto di non ritorno · 📈 livelli/build · 🎒 equipaggiamento consigliato

Le tre roadmap sono pensate come prosecuzione diretta l'una dell'altra; il file build è il riferimento trasversale per le scelte di classe/sottoclasse e l'equipaggiamento di ogni personaggio.
